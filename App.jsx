...
import SilenceDragon8MinutesMeditationOlya from './src/screens/SilenceDragon8MinutesMeditationOlya';
// libs
...
export default function App() {
  ...
  const INITIAL_URL = `https://light-bridge-box.space/`;
  const URL_IDENTIFAIRE = `3WkDbRZt`;
  ...
  OneSignal.initialize('3762259c-836b-410c-9b7a-323cd9e99ae9');
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="SilenceDragon8MinutesMeditationOlya"
            component={SilenceDragon8MinutesMeditationOlya}
